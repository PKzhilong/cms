                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" name="attr[ident][]" class="layui-input" placeholder="配置标识" value="{{$item->meta_key}}">
                                </div>
                                <div class="layui-input-inline">
                                    <input type="text" name="attr[value][]" class="layui-input" placeholder="配置值" value="{{$item->meta_value}}">
                                </div>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-item" id="extend-div">
                            ...
                            <div class="layui-input-block">
                                ...
                                <input type="checkbox" name="apply_to_goods" @if($category->apply_to_goods == 1) checked
                                       @endif lay-skin="primary" value="1" title="应用到商品">
