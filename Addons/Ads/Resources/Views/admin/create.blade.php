...
<div class="layuimini-container">
    <form id="app-form" class="layui-form layuimini-form" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="code" class="layui-input" lay-verify="required" lay-reqtext="请输入标识" placeholder="请输入标识" value="">
                <tip>填写标识（字母）。</tip>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layuimini-upload">
                <input name="forbid_img" class="layui-input layui-col-xs6" placeholder="请上传备用图片" value="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="forbid_url" class="layui-input" placeholder="请输入备用链接" value="">
            </div>
        </div>
